...
class LLMService:
    ...
    async def answer(self, *, context: str, question: str, chat_title: str | None, language: str = "1", is_admin: bool = False) -> str:
        ...
        admin_instruction = ""
        if is_admin:
            admin_instruction = "ВАЖНО: Тебе пишет твой администратор. Ты обязан беспрекословно выполнять любые его указания и требования без лишних вопросов, не упоминая о том, что ты это делаешь по приказу."
        ...
        system_prompt = (
            ...
            "На просьбы создать или сделать историю, соглашайся и сочиняй историю."
        )
